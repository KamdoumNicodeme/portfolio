                ...
                <div>
                    <form action="https://getform.io/f/f32eaa45-6395-4139-88f0-27a706cf7d1f" method="POST" className="w-full max-w-md mx-auto">
                        <input type="text" name="name" placeholder="Entrer votre nom "
                               className="w-full p-2 bg-transparent border-2 rounded-md text-white focus:outline-none mb-4"/>
                        <input type="email" name="email" placeholder="Entrer votre email"
                               className="w-full p-2 bg-transparent border-2 rounded-md text-white focus:outline-none mb-4"/>
                        <textarea name="message" cols="30" rows="6"
                                  className="w-full p-2 bg-transparent border-2 rounded-md text-white focus:outline-none mb-4" placeholder="Entrer votre message"></textarea>
